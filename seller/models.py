...
class Seller(models.Model):
    ...
    seller_products = models.ManyToManyField("seller.Product", verbose_name="listOfSellerProd", null=True, blank=True)
...
class Product(models.Model):
    ...
    product_category = models.ManyToManyField("seller.ProductCategory", verbose_name="listOfCat")
    products_sellers = models.ManyToManyField('seller.Seller')

    def __str__(self):
        return self.product_name+ "  -  " + ''.join(str(i)+", " for i in self.product_category.all())
...
class ProductCategory(models.Model):
    ...
    category_products = models.ManyToManyField("seller.Product", verbose_name="listOfProd",blank = True, null = True)
